...
CREATE POLICY "Allow authenticated users to upload to community 1ajt695_0" ON "storage"."objects" FOR INSERT WITH CHECK ((("bucket_id" = 'community'::"text") AND ("auth"."uid"() IS NOT NULL)));
